			...
			Expect(*sp).To(
				MatchFields(IgnoreExtras, Fields{
					"Spec": MatchFields(IgnoreExtras, Fields{
						"TargetRef": MatchFields(IgnoreExtras, Fields{
							"PolicyTargetReference": MatchFields(IgnoreExtras, Fields{
								...
								"Namespace": PointTo(Equal(gatewayapiv1.Namespace(testNamespace))),
							}),
						}),
						"ExtAuth": PointTo(MatchFields(IgnoreExtras, Fields{
							"GRPC": PointTo(MatchFields(IgnoreExtras, Fields{
								"BackendRef": MatchFields(IgnoreExtras, Fields{
